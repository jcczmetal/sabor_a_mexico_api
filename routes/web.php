...
Route::middleware(['auth','role:associate|admin|keymaker'])->namespace('Associates')->group(function () {
    ...
    Route::get('restaurant/{slug}/photos',           'LocalPhotoController@index')->name('index-restaurant-photos');
    Route::post('restaurant/photos/store',           'LocalPhotoController@store')->name('store-restaurant-photo');
